...
{    
     ...
     */
    public ActorWorld(framework.info.gridworld.grid.Grid<Actor> grid)
    {
        super(grid);
    }
    ...
    public void step()
    {
        framework.info.gridworld.grid.Grid<Actor> gr = getGrid();
        ArrayList<Actor> actors = new ArrayList<Actor>();
        for (framework.info.gridworld.grid.Location loc : gr.getOccupiedLocations())
